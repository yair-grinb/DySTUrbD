...
from auxilliary_functions import compute_network, create_routines, compute_building_value, create_social_network
...
def create_world():
    ...
    # TODO: Add activity columns and epidemic columns(done)
    
    # TODO: Call to create_social_network from auxilliary functions (done)
    print ('creating social network', time() - t)
    G = create_social_network(gv.indivs, gv.households, gv.bldgs)
    agents_reg = gv.indivs[:, [0,7,12,18,7]]        
    # create routines
    print ('creating routines', time() - t)
    create_routines(agents_reg, G)
